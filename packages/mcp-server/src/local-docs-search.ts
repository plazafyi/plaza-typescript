...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "response": "{ features: { geometry: geometry; properties: object; type: 'Feature'; id?: string; }[]; type: 'FeatureCollection'; }",
  ...
  },
  {
    ...
    "response": "{ geometry: object | object | object | object | object | object; properties: object; type: 'Feature'; id?: string; }",
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Features.Retrieve",
        "example": "FeatureRetrieveParams parameters = new()\n{\n    Type = \"type\",\n    ID = 0,\n};\n\nvar geoJsonFeature = await client.Features.Retrieve(parameters);\n\nConsole.WriteLine(geoJsonFeature);"
      },
      "http": {
        "example": "curl https://plaza.fyi/api/v1/features/$TYPE/$ID \\\n    -H \"Authorization: Bearer $PLAZA_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Features.Batch",
        "example": "FeatureBatchParams parameters = new()\n{\n    Elements =\n    [\n        new()\n        {\n            ID = 21154906,\n            Type = Type.Node,\n        },\n        new()\n        {\n            ID = 4589123,\n            Type = Type.Way,\n        },\n    ],\n};\n\nvar featureCollection = await client.Features.Batch(parameters);\n\nConsole.WriteLine(featureCollection);"
      },
      "http": {
        "example": "curl https://plaza.fyi/api/v1/features/batch \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $PLAZA_API_KEY\" \\\n    -d '{\n          \"elements\": [\n            {\n              \"id\": 21154906,\n              \"type\": \"node\"\n            },\n            {\n              \"id\": 4589123,\n              \"type\": \"way\"\n            }\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ datasets: { id: string; inserted_at: string; name: string; scope: 'plaza' | 'user'; slug: string; status: 'pending' | 'processing' | 'ready' | 'error'; updated_at: string; address_count?: number; attribution?: string; description?: string; edge_count?: number; error_message?: string; feature_count?: number; license?: string; schema_definition?: object; source_format?: string; source_url?: string; storage_bytes?: number; strict_mode?: boolean; }[]; }",
  ...
  },
  {
    ...
    "response": "{ id: string; inserted_at: string; name: string; scope: 'plaza' | 'user'; slug: string; status: 'pending' | 'processing' | 'ready' | 'error'; updated_at: string; address_count?: number; attribution?: string; description?: string; edge_count?: number; error_message?: string; feature_count?: number; license?: string; schema_definition?: object; source_format?: string; source_url?: string; storage_bytes?: number; strict_mode?: boolean; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Datasets.Retrieve",
        "example": "DatasetRetrieveParams parameters = new() { ID = \"id\" };\n\nvar dataset = await client.Datasets.Retrieve(parameters);\n\nConsole.WriteLine(dataset);"
      },
      "http": {
        "example": "curl https://plaza.fyi/api/v1/datasets/$ID \\\n    -H \"Authorization: Bearer $PLAZA_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Datasets.Delete",
        "example": "DatasetDeleteParams parameters = new() { ID = \"id\" };\n\nawait client.Datasets.Delete(parameters);"
      },
      "http": {
        "example": "curl https://plaza.fyi/api/v1/datasets/$ID \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $PLAZA_API_KEY\""
      }
  ...
  },
  {
    ...
    "response": "{ features: { geometry: geometry; properties: object; type: 'Feature'; }[]; type: 'FeatureCollection'; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Geocode.Autocomplete",
        "example": "GeocodeAutocompleteParams parameters = new() { Q = \"221B Bak\" };\n\nvar autocompleteResult = await client.Geocode.Autocomplete(parameters);\n\nConsole.WriteLine(autocompleteResult);"
      },
      "http": {
        "example": "curl https://plaza.fyi/api/v1/geocode/autocomplete \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $PLAZA_API_KEY\" \\\n    -d '{\n          \"q\": \"221B Bak\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Geocode.Batch",
        "example": "GeocodeBatchParams parameters = new()\n{\n    Addresses =\n    [\n        \"string\"\n    ],\n};\n\nvar response = await client.Geocode.Batch(parameters);\n\nConsole.WriteLine(response);"
      },
      "http": {
        "example": "curl https://plaza.fyi/api/v1/geocode/batch \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $PLAZA_API_KEY\" \\\n    -d '{\n          \"addresses\": [\n            \"string\"\n          ]\n        }'"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ geometry: object | object | object | object | object | object; properties: { distance_m: number; duration_s: number; annotations?: object; charge_profile?: number[][]; charging_stops?: object[]; edges?: object[]; energy_used_wh?: number; }; type: 'Feature'; }",
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Routing.Route",
        "example": "RoutingRouteParams parameters = new()\n{\n    Destination = new()\n    {\n        Coordinates =\n        [\n            2.2945, 48.8584\n        ],\n        Type = Type.Point,\n    },\n    Origin = new()\n    {\n        Coordinates =\n        [\n            2.3522, 48.8566\n        ],\n        Type = Type.Point,\n    },\n};\n\nvar routeResult = await client.Routing.Route(parameters);\n\nConsole.WriteLine(routeResult);"
      },
      "http": {
        "example": "curl https://plaza.fyi/api/v1/route \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $PLAZA_API_KEY\" \\\n    -d '{\n          \"destination\": {\n            \"coordinates\": [\n              2.2945,\n              48.8584\n            ],\n            \"type\": \"Point\"\n          },\n          \"origin\": {\n            \"coordinates\": [\n              2.3522,\n              48.8566\n            ],\n            \"type\": \"Point\"\n          }\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ geometry: object | object | object | object | object | object; properties: { distance_m?: number; edge_id?: number; edge_length_m?: number; highway?: string; osm_way_id?: number; surface?: string; }; type: 'Feature'; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "routing isochrone",
        "example": "plaza routing isochrone \\\n  --api-key 'My API Key' \\\n  --geometry '{coordinates: [2.3522, 48.8566], type: Point}' \\\n  --time 1"
      },
      "php": {
        "method": "routing->isochrone",
        "example": "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key', environment: 'local');\n\n$response = $client->routing->isochrone(\n  geometry: ['coordinates' => [2.3522, 48.8566], 'type' => 'Point'],\n  time: [1],\n  format: 'format',\n  mode: 'auto',\n);\n\nvar_dump($response);"
  ...
  },
  {
    ...
    "response": "{ geometry: object | object | object | object | object | object; properties: { elevation_m: number; }; type: 'Feature'; }",
  ...
  },
  {
    ...
    "response": "{ geometry: object | object | object | object | object | object; properties: { avg_elevation_m: number; max_elevation_m: number; min_elevation_m: number; total_ascent_m: number; total_descent_m: number; }; type: 'Feature'; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "elevation profile",
        "example": "plaza elevation profile \\\n  --api-key 'My API Key' \\\n  --geometry '{coordinates: [[2.3522, 48.8566], [2.34, 48.858], [2.2945, 48.8584]], type: LineString}'"
      },
      "php": {
        "method": "elevation->profile",
  ...
  },
  {
    ...
    "response": "{ features: { geometry: point_geometry | line_string_geometry | polygon_geometry | multi_point_geometry | multi_line_string_geometry | multi_polygon_geometry; properties: { distance_m?: number; edge_id?: number; matchings_index?: number; name?: string; original?: number[]; waypoint_index?: number; }; type: 'Feature'; }[]; matchings: object[]; type: 'FeatureCollection'; }",
  ...
  },
  {
    ...
    "response": "{ features: { geometry: geometry; properties: object; type: 'Feature'; }[]; optimization: string; roundtrip: boolean; total_cost_s: number; type: 'FeatureCollection'; } | { job_id: string; status: 'processing'; }",
  ...
  },
  {
    ...
    "response": "{ status: 'completed' | 'processing'; result?: { features: object[]; optimization: string; roundtrip: boolean; total_cost_s: number; type: 'FeatureCollection'; }; }",
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Optimize.Retrieve",
        "example": "OptimizeRetrieveParams parameters = new() { JobID = \"job_id\" };\n\nvar optimizeJobStatus = await client.Optimize.Retrieve(parameters);\n\nConsole.WriteLine(optimizeJobStatus);"
      },
      "http": {
        "example": "curl https://plaza.fyi/api/v1/optimize/$JOB_ID \\\n    -H \"Authorization: Bearer $PLAZA_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Query.Execute",
        "example": "QueryExecuteParams parameters = new()\n{\n    Data = \"$$ = search(node, amenity: \\\"cafe\\\").around(distance: 500, geometry: point(48.8566, 2.3522));\",\n};\n\nvar featureCollection = await client.Query.Execute(parameters);\n\nConsole.WriteLine(featureCollection);"
      },
      "http": {
        "example": "curl https://plaza.fyi/api/v1/query \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $PLAZA_API_KEY\" \\\n    -d '{\n          \"data\": \"$$ = search(node, amenity: \\\\\"cafe\\\\\").around(distance: 500, geometry: point(48.8566, 2.3522));\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Tiles.Get",
        "example": "TileGetParams parameters = new()\n{\n    Z = 0,\n    X = 0,\n    Y = 0,\n};\n\nvar tile = await client.Tiles.Get(parameters);\n\nConsole.WriteLine(tile);"
      },
      "http": {
        "example": "curl https://plaza.fyi/api/v1/tiles/$Z/$X/$Y \\\n    -H \"Authorization: Bearer $PLAZA_API_KEY\""
      }
    }
  }
];
