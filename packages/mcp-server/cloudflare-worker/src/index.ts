...
import { McpOptions } from '@plazafyi/mcp/options';
import { initMcpServer, newMcpServer } from '@plazafyi/mcp/server';
import { configureLogger } from '@plazafyi/mcp/logger';
...
function fallbackMcpServer(): McpServer {
  return new McpServer(
    { name: 'plazafyi_sdk_api', version: '0.2.0' },
